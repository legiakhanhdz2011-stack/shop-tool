...
const els = {
  ...
  btnHistory: $("#btnHistory"), btnSeller: $("#btnSeller"),
...
function updateHeader() {
  ...
  els.btnSeller.classList.toggle("hidden", !(loggedIn && (me.role === "seller" || me.role === "admin")));
  if (loggedIn) els.balanceVal.textContent = Number(me.balance).toLocaleString("vi-VN");
}

els.btnSeller.addEventListener("click", () => window.location.href = "/seller.html");
  ...
  try {
    ...
    list.innerHTML = orders.map(o => `
      <div class="history-item">
        ...
        <div class="item-code">${o.deliveredItem}</div>
